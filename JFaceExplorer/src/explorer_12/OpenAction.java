...
public class OpenAction extends Action implements ISelectionChangedListener, IDoubleClickListener {
	...
	public OpenAction(Explorer w) {
		...
		setEnabled(false);
		setImageDescriptor(ImageDescriptor.createFromURL(Util.newURL("file:icons/run.png")));
	}
	...
	public void selectionChanged(SelectionChangedEvent event) {
		...
		if (file.isFile()) {
			...
			setToolTipText("Run the program asociated with " + file.getName() + " with this file as the argument");
		}
	}
