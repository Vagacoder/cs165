...
/**
 * SBCCDrawFrame is the main window (frame) for the app. It handles menu and
 * toolbar interaction. DrawPanel handles interaction related to drawing on the
 * canvas.
 */
...
public class SbccDrawFrame extends JFrame implements DrawShapeNamesChangedListener {
  ...
  private void jbInit() throws Exception {
    ...
    cmbShape = new JComboBox(shapeFactory.getDrawShapeNames().toArray());
