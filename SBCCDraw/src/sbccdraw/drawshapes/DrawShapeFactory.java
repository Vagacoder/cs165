...
/**
 * DrawShapeFactory is used to create new DrawShapes. Upon instantiation, DrawShapeFactory finds the .class files for
 * all DrawShapes in ./classes/sbccdraw/drawshapes/ . It provides access to the list of DrawShape names via via
 * getShapeNames().
 */
public class DrawShapeFactory {
	...
	/**
	 * This is the FACTORY METHOD. It takes a shape name, or more accurately the shape's class name, and returns the
	...
	/**
	 * This method allows client to see what types of DrawShapes are currently available.
	 */
	...
	/**
	 * This constructor loads an initial set of DrawShape classes from the default path. Then it starts a background
	 * service that watches for additions to or deletions from the set of DrawShape classes.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Watches for additions to or deletions from the set of DrawShapes. If a change is detected, the list of classes is
	 * updated, and listeners are informed of the change.
	 */
	 ...
	 * 
	 * @param pathToDrawShapeClasses Path to the DrawShapes files (including trailing "/")
	 */
	...
	/**
	 * Adds a client to the list of clients to inform when the DrawShapeNames list changes.
	 */
	...
	/**
	 * Removes a client from the list of clients to inform when the DrawShapeNames list changes.
	 */
