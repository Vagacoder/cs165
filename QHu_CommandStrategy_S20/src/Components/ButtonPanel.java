...
public class ButtonPanel extends JPanel{
    ...
    public ButtonPanel() {
        ...
        advancePanel.setBackground(Color.lightGray);
        advancePanel.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createTitledBorder("Advance Functions"),
        ...
        basicPanel.setBackground(Color.lightGray);
        basicPanel.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createTitledBorder("Basic Functions"),
            BorderFactory.createEmptyBorder(5, 5, 5, 5)));
